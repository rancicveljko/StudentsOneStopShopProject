...
import { TabPanelProps, Info } from "./templateDataViewInterfaces";
import React, { MouseEventHandler } from "react";
import useStyles from "./templateDataViewStyles";
import ComboBox from "./templateDataComboBox";
import Filter from "./templateDataFilter";
import { useFormik } from "formik";
import ActionsInAccordion from "./templateAccordion";
...
function FetchDataRange(first: number, last: number) {
  ////////////////////////////////////////
  const data: string[] = ["0dfdf", "1dfdf", "2dfdf", "3dfdf"];
  return data;
  /* fetch(`${USERS_API_URL}`, {
    method: "post",
    headers: {
...
export default function TemplateDataView() {
  {
